...
- [ ] 6. **Добавить retranslateUi() вызовы** во все 5 компонентов после uic.loadUi()

- [ ] 7. **Переизвлечь строки pylupdate5** из reverted .ui файлов

- [ ] 8. **Перекомпилировать .qm файлы**
